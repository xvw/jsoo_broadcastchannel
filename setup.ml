...
(* OASIS_START *)
(* DO NOT EDIT (digest: e5167f26f35bf58036c48ab4e96451ca) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/xvw/jsoo_broadcastchannel";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Allow a proper way to have a communication bus between window of the same origin"
              ];
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["BroadcastChannel"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "jsoo_broadcastchannel";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/jsoo_broadcastchannel";
                      doc_title =
                        "Documentation and API reference for BroadcastChannel";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xvw/jsoo_broadcastchannel.git";
                      src_repo_browser =
                        Some "https://github.com/xvw/jsoo_broadcastchannel";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\216\143\158\152d#\206R\253\179\218\157\14681\132";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
